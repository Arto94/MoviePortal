...
<head>
    ...
    <link rel="profile" href="userfavoritelist.html#">
        ...
        <div class="row ipad-width2">
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="topbar-filter user">
                    <p>Found <span>${favoriteMovies.size()}</span> in total</p>

                    <a href="#" class="list"><i class="ion-ios-list-outline active"></i></a>
                    <a  href="/userFavoriteMovies?userId=${user.id}&&n=1" class="grid"><i class="ion-grid "></i></a>
                </div>
                <div class="flex-wrap-movielist user-fav-list">
                    ...
                    <div class="movie-item-style-2">
                        ...
                        <div class="mv-item-infor">
                            ...
                            <p class="run-time"> Run Time: ${movie.movieTime}.</p>
                            <p>Director: <a href="#">${movie.movieDirectors.get(0).name} ${movie.movieDirectors.get(0).surname}</a></p>
                            <p>Stars:
                                <c:forEach items="${movie.movieActors}" var="movieActor">
                                <a href="/singleActor?actorId=${movieActor.id}">${movieActor.name} ${movieActor.surname}</a>
                                </c:forEach>
                            </p>
                        </div>
                    </div>
