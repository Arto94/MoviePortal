...
<head>
    ...
    <link rel="profile" href="celebritylist.html#">
        ...
        <div class="row ipad-width2">
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="topbar-filter">
                    <p class="pad-change">Found <span>${actors.size()} celebrities</span> in total</p>
                    <a href="#" class="list"><i class="ion-ios-list-outline active"></i></a>
                    <a  href="/actors1" class="grid"><i class="ion-grid "></i></a>
                </div>
                <div class="row">
                    <c:forEach items="${actors}" var="actor">
                    <div class="col-md-12">
                        <div class="ceb-item-style-2">
                            <img class="movieActorsImgStyle" src="/image?fileName=${actor.pic}" alt="">
                            <div class="ceb-infor">
            ...
            <div class="col-md-3 col-xs-12 col-sm-12">
                ...
                <div class="sidebar">
                    <div class="searh-form">
                        ...
                        <form class="form-style-1 celebrity-form" action="/searchActor">
                            <div class="row">
